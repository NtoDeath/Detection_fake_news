"""
Évaluation complète du Pipeline Knowledge-based
...
def load_fever_dataset():
    """Charge et prépare le dataset FEVER"""
    print("📂 Chargement du dataset FEVER...")
...
def plot_confusion_matrix(cm, labels):
    ...
    plt.title('Matrice de Confusion - Pipeline Knowledge-based')
    plt.tight_layout()
...
def generate_report(y_true, y_pred, cm, labels_order, retrieval_stats):
    ...
    with open(report_file, 'w', encoding='utf-8') as f:
        f.write("=" * 70 + "\n")
        f.write("RAPPORT D'ÉVALUATION - PIPELINE KNOWLEDGE-BASED\n")
        f.write("=" * 70 + "\n\n")
...
def main():
    ...
    print("=" * 70)
    print("🚀 EVALUATION - KNOWLEDGE BRANCH PIPELINE")
    print("=" * 70)
    print()
